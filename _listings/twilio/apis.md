...
- name: Twilio
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/lists/master/_listings/twilio/accounts-accountsid-sip-credentiallists-clsid-credentials-credentialsid-post.md
x-common:
- type: x-net-library
