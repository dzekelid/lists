...
- name: Twilio Get SIP Credentials List
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/twilio/accounts-accountsid-sip-credentiallists-clsid-get-postman.md
x-common:
- type: x-net-library
