...
- name: Elastic Email SMTP API - Create New List
  x-api-slug: listscreatelists-get
...
- name: Elastic Email SMTP API - Unsubscribed
  x-api-slug: mailerlistsunsubscribed-get
...
- name: Elastic Email SMTP API - Listing of Active Channels
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/elastic-email/mailerchannellist-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/elastic-email/mailerchannellist-get-openapi.md
- name: Elastic Email SMTP API - Bounced
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/elastic-email/mailerlistbounced-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/elastic-email/mailerlistbounced-get-openapi.md
- name: Elastic Email SMTP API - Complaint
  x-api-slug: mailerlistcomplaint-get
  description: This api will return you the list of email addresses which are currently
    in your block list.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/586-elastic-email.jpg
  humanURL: http://elasticemail.com
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/elastic-email/mailerlistcomplaint-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/elastic-email/mailerlistcomplaint-get-openapi.md
- name: Elastic Email SMTP API - Complaint
  x-api-slug: mailerlistcomplaint-get
  description: This api will return you the list of email addresses which are currently
    in your block list.
