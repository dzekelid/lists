...
- name: Disqus
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/disqus/whitelists-remove-json-post.md
- name: Disqus Forums ListUserModerationHistory
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/disqus/forums-listusermoderationhistory-json-get.md
x-common:
- type: x-base
