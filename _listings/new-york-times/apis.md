...
- name: New York Times
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/new-york-times/lists-format-get.md
- name: New York Times Best Seller List
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/new-york-times/books-v2-lists-format-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/new-york-times/books-v2-lists-format-get-postman.md
x-common:
