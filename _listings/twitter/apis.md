...
- name: Twitter Remove Members
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/twitter/list-members-destroy-all-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/twitter/list-members-destroy-all-get-postman.md
x-common:
- type: x-net-library
