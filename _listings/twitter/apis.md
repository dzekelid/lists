...
- name: Twitter Add List Subscribers
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/twitter/lists-subscribers-create-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/twitter/lists-subscribers-create-post-postman.md
x-common:
- type: x-net-library
