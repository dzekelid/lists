...
- name: SoundCloud
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/soundcloud/playlists-playlist-id-json-get.md
- name: SoundCloud Get User Playlists
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/soundcloud/users-user-id-playlists-json-get.md
x-common:
- type: x-base
