...
- name: Spotify Add User Playlist Track
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/spotify/users-user-id-playlists-playlist-id-tracks-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/spotify/users-user-id-playlists-playlist-id-tracks-post-postman.md
x-common:
