...
- name: Spotify Get User Playlist
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/spotify/users-user-id-playlists-playlist-id-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/spotify/users-user-id-playlists-playlist-id-get-postman.md
x-common:
