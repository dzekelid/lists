...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/lists/master/_listings/akamai/network-list-v1-network-lists-networklistid-element-element-delete.md
x-common:
- type: x-base
