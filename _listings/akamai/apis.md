...
- name: Akamai API Activate a Network List
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/akamai/network-list-v1-network-lists-networklistid-activate-post.md
x-common:
- type: x-base
