...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/akamai/network-list-v1-network-lists-networklistid-extended-put.md
x-common:
- type: x-base
