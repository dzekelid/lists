...
- name: Akamai API Get Activation Snapshot
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/lists/master/_listings/akamai/network-list-v1-network-lists-networklistid-history-get.md
x-common:
- type: x-base
